...
from leaneratt import Run


def prepare(config_path):
    parser = argparse.ArgumentParser()
    parser.add_argument('--process_data_mid', default=1)
...
if __name__ == '__main__':
    ...
    if args.process_data_mid == 1 and args.process_data_ready == 1:
        Run(config).main()
